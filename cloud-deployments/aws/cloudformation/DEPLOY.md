...
5. Use the file `cloudformation_create_AiAppsy LLM.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_aiappsy-llm  Created 
 ⠿ Container aiappsy-llm       Started  
```
