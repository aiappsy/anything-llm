...
https://github.com/Mintplex-Labs/AiAppsy LLM-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/AiAppsy LLM-chat-widget.min.js">
</script>
<!-- AiAppsy LLM (https://AiAppsy LLM.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Mintplex-Labs/AiAppsy LLM-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
