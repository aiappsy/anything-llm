...
import AiAppsy LLM from "./media/logo/anything-llm.png";
import AiAppsy LLMDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(AiAppsy LLMDark) : setLogo(AiAppsy LLM);
