...
export default {
  ...
  docs: () => {
    return "https://docs.AiAppsy LLM.com";
  },
  chatModes: () => {
    return "https://docs.AiAppsy LLM.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@mintplexlabs.com";
  },
  hosting: () => {
    return "https://my.mintplexlabs.com/aio-checkout?product=AiAppsy LLM";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.AiAppsy LLM.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.AiAppsy LLM.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.AiAppsy LLM.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.AiAppsy LLM.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
