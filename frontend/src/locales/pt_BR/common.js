...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao AiAppsy LLM",
      description: "Ajude-nos a melhorar o AiAppsy LLM. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o AiAppsy LLM?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o AiAppsy LLM?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do AiAppsy LLM",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O AiAppsy LLM seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do AiAppsy LLM com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o AiAppsy LLM.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o AiAppsy LLM lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do AiAppsy LLM. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do AiAppsy LLM ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
