...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bun venit la AiAppsy LLM",
      description:
        "Ajută-ne să facem AiAppsy LLM potrivit pentru nevoile tale. Opțional.",
      email: "Care este adresa ta de email?",
      useCase: "Pentru ce vei folosi AiAppsy LLM?",
      useCaseWork: "Pentru muncă",
      useCasePersonal: "Pentru uz personal",
      useCaseOther: "Altele",
      comment: "De unde ai aflat despre AiAppsy LLM?",
      commentPlaceholder:
  ...
  vector: {
    ...
    description:
      "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta AiAppsy LLM. Este important să fie corecte și actuale.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și AiAppsy LLM gestionează datele tale.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță AiAppsy LLM. Aceste fișiere nu sunt trimise sau partajate cu o terță parte.",
    },
    pinning: {
      what_pinning: "Ce este fixarea documentelor?",
      pin_explained_block1:
        "Când **fixezi** un document în AiAppsy LLM, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      pin_explained_block3:
        "Dacă nu obții răspunsurile dorite de la AiAppsy LLM în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      accept: "Ok, am înțeles",
    },
    watching: {
      what_watching: "Ce face vizualizarea unui document?",
      watch_explained_block1:
        "Când **urmărești** un document în AiAppsy LLM, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Trebuie să te autentifici cu AiAppsy LLM Community Hub înainte de a publica elemente.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Permite utilizarea nelimitată a instrumentelor și reduce utilizarea token-urilor cu până la 80% pentru fiecare interogare – AiAppsy LLM selectează automat abilitățile potrivite pentru fiecare solicitare.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      title: "Preferințe UI",
      description: "Setează preferințele UI pentru AiAppsy LLM.",
    },
    branding: {
      title: "Branding & White-labeling",
      description:
        "Personalizează-ți instanța AiAppsy LLM cu branding personalizat.",
    },
    chat: {
      title: "Chat",
      description: "Setează preferințele de chat pentru AiAppsy LLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selectează limba preferată pentru a reda interfața AiAppsy LLM - atunci când traducerile sunt disponibile.",
      },
      logo: {
        title: "Logo brand",
        description:
  ...
  api: {
    title: "Chei API",
    description:
      "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță AiAppsy LLM.",
  ...
  llm: {
    title: "Preferința LLM",
    description:
      "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel AiAppsy LLM nu va funcționa corect.",
  ...
  transcription: {
    ...
    "warn-start":
      "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca AiAppsy LLM la procesarea fișierelor media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care AiAppsy LLM îl poate utiliza pentru procesare.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protejează instanța AiAppsy LLM cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
  ...
  telegram: {
    ...
    description:
      "Conectați instanța dumneavoastră AiAppsy LLM cu Telegram, astfel încât să puteți interacționa cu spațiile de lucru de pe orice dispozitiv.",
    setup: {
      step1: {
