...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast AiAppsy LLM-i",
      description:
        "Aita meil AiAppsy LLM sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad AiAppsy LLM-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid AiAppsy LLM-ist?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "AiAppsy LLM mobiilversioon",
    "community-hub": {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beeta",
        description:
          "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – AiAppsy LLM valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Sea AiAppsy LLM-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma AiAppsy LLM kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles AiAppsy LLM UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda AiAppsy LLM instantsi.",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul AiAppsy LLM ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et AiAppsy LLM saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas AiAppsy LLM töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja AiAppsy LLM-i andmekäitluse kohta.",
  ...
  telegram: {
    title: "Telegrami bot",
    description:
      "Ühendage oma AiAppsy LLM instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    setup: {
      step1: {
