...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM może współpracować z wieloma dostawcami modeli językowych",
    },
    userSetup: {
    ...
    survey: {
      title: "Witamy w AiAppsy LLM",
      description:
        "Pomóż nam stworzyć AiAppsy LLM dostosowany do Twoich potrzeb. Opcjonalnie.",
      email: "Jaki jest Twój adres e-mail?",
      useCase: "Do czego będziesz używać AiAppsy LLM?",
      useCaseWork: "Do pracy",
      useCasePersonal: "Do użytku osobistego",
      useCaseOther: "Inne",
      comment: "Skąd dowiedziałeś się o AiAppsy LLM?",
      commentPlaceholder:
  ...
  customization: {
    interface: {
      ...
      description: "Ustaw preferencje interfejsu użytkownika dla AiAppsy LLM.",
    },
    branding: {
      title: "Branding i white-labeling",
      description:
        "Oznakuj swoją instancję AiAppsy LLM niestandardowym brandingiem.",
    },
    chat: {
      title: "Czat",
      description: "Ustaw preferencje czatu dla AiAppsy LLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Język",
        description:
          "Wybierz preferowany język interfejsu użytkownika AiAppsy LLM - jeśli dostępne są tłumaczenia.",
      },
      logo: {
        title: "Logo",
        description:
  ...
  api: {
    title: "Klucze API",
    description:
      "Klucze API umożliwiają dostęp do instancji AiAppsy LLM i zarządzanie nią.",
  ...
  llm: {
    ...
    description:
      "Tutaj skonfigurujesz dostawcę modeli językowych używanych do czatów i embeddingów. Upewnij się, że wszystkie klucze są aktualne i poprawne - bez tego AiAppsy LLM nie będzie działać.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korzystanie z lokalnego modelu Whisper na komputerach z ograniczoną pamięcią RAM lub procesorem może spowodować przerwanie pracy AiAppsy LLM podczas przetwarzania plików multimedialnych.",
    "warn-recommend":
  ...
  vector: {
    ...
    description:
      "Tutaj skonfigurujesz wektorową bazę danych dla AiAppsy LLM. Upewnij się, że wszystkie ustawienia są poprawne.",
    provider: {
      title: "Wektorowa baza danych",
  ...
  privacy: {
    ...
    description:
      "Jest to konfiguracja sposobu, w jaki połączeni dostawcy zewnętrzni i AiAppsy LLM przetwarzają dane użytkownika.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Pliki zostaną przetworzone w obrębie danej instancji AiAppsy LLM. Pliki te nie będą udostępniane innym podmiotom.",
    },
    pinning: {
      what_pinning: "Czym jest przypinanie dokumentów?",
      pin_explained_block1:
        "Kiedy <b>przypinasz</b> dokument w AiAppsy LLM, dodamy całą zawartość dokumentu do okna promptu, aby LLM mógł w pełni zrozumieć jego treść.",
      ...
      pin_explained_block3:
        "Jeśli domyślnie nie otrzymujesz pożądanych odpowiedzi z AiAppsy LLM, przypinanie jest świetnym sposobem na uzyskanie wyższej jakości odpowiedzi za jednym kliknięciem.",
      accept: "Ok, rozumiem",
    },
    watching: {
      what_watching: "Do czego służy oglądanie dokumentu?",
      watch_explained_block1:
        "Podczas <b>obserwowania</b> dokumentu w AiAppsy LLM będziemy <i>automatycznie</i> synchronizować zawartość dokumentu z jego oryginalnym źródłem w regularnych odstępach czasu. Spowoduje to automatyczną aktualizację zawartości w każdym obszarze roboczym, w którym ten plik jest zarządzany.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Przed opublikowaniem elementów należy uwierzytelnić się w centrum społeczności AiAppsy LLM.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chroń swoją instancję AiAppsy LLM hasłem. Jeśli go zapomnisz, nie ma metody odzyskiwania, więc upewnij się, że zapisałeś to hasło.",
  ...
  telegram: {
    ...
    description:
      "Połącz swoją instancję AiAppsy LLM z Telegramem, aby móc rozmawiać z przestrzeniami roboczymi z dowolnego urządzenia.",
    setup: {
      step1: {
