const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to AiAppsy LLM",
      description: "Help us make AiAppsy LLM built for your needs. Optional.",
      email: "What's your email?",
      useCase: "What will you use AiAppsy LLM for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about AiAppsy LLM?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of AiAppsy LLM",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Enable unlimited tools and cut token usage by up to 80% per query — AiAppsy LLM automatically selects the right skills for every prompt.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for AiAppsy LLM.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your AiAppsy LLM instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for AiAppsy LLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render AiAppsy LLM's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this AiAppsy LLM instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else AiAppsy LLM will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall AiAppsy LLM when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which AiAppsy LLM can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your AiAppsy LLM instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Connect your AiAppsy LLM instance to Telegram so you can chat with your workspaces from any device.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your AiAppsy LLM instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and AiAppsy LLM handle your data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this AiAppsy LLM instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in AiAppsy LLM we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from AiAppsy LLM by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in AiAppsy LLM we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the AiAppsy LLM Community Hub before publishing items.",
