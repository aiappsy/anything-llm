...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Waarvoor ga je AiAppsy LLM gebruiken?",
      useCaseWork: "Voor werk",
      useCasePersonal: "Voor persoonlijk gebruik",
      useCaseOther: "Anders",
      comment: "Hoe heb je over AiAppsy LLM gehoord?",
      commentPlaceholder:
      ...
      title: "Welkom bij AiAppsy LLM",
      description:
        "Help ons AiAppsy LLM af te stemmen op jouw behoeften. (Optioneel)",
    },
    home: {
      title: "Welkom bij",
    ...
    llm: {
      ...
      description:
        "AiAppsy LLM kan samenwerken met veel LLM-aanbieders. Deze service verzorgt de chatfunctie.",
    },
    userSetup: {
  ...
  settings: {
    ...
    chat: "Chat",
    "mobile-app": "AiAppsy LLM Mobiele App",
    "community-hub": {
      title: "Centraal punt",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Leg me uit",
      body: "de voordelen van AiAppsy LLM",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Betaling",
        description:
          'Maak gebruik van een onbeperkt aantal tools en verminder het gebruik van "cut tokens" met tot wel 80% per query – AiAppsy LLM selecteert automatisch de juiste vaardigheden voor elke vraag.',
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-sleutels",
    description:
      "API-sleutels stellen de houder in staat om deze AiAppsy LLM-instantie programmatisch te openen en beheren.",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal AiAppsy LLM niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan AiAppsy LLM vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat AiAppsy LLM kan gebruiken om te verwerken.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dit zijn de inloggegevens en instellingen voor hoe je AiAppsy LLM-instantie zal functioneren. Het is belangrijk dat deze sleutels actueel en correct zijn.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en AiAppsy LLM je gegevens verwerken.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Deze bestanden worden geüpload naar de documentverwerker die op deze AiAppsy LLM-instantie draait. Deze bestanden worden niet verzonden naar of gedeeld met derden.",
    },
    pinning: {
      what_pinning: "Wat is het vastzetten van documenten?",
      pin_explained_block1:
        "Wanneer u een document vastzet in AiAppsy LLM, injecteren we de volledige inhoud van het document in uw promptvenster, zodat uw LLM het volledig kan begrijpen.",
      ...
      pin_explained_block3:
        "Als u standaard niet de gewenste antwoorden krijgt van AiAppsy LLM, is vastzetten een uitstekende manier om met één klik antwoorden van hogere kwaliteit te krijgen.",
      accept: "Oké, begrepen.",
    },
    watching: {
      what_watching: "Wat doet het volgen van een document?",
      watch_explained_block1:
        "Wanneer u een document in AiAppsy LLM volgt, synchroniseren we de inhoud van uw document automatisch met regelmatige tussenpozen vanuit de originele bron. Hierdoor wordt de inhoud in elke werkruimte waar dit bestand wordt beheerd automatisch bijgewerkt.",
  ...
  customization: {
    interface: {
      title: "UI-voorkeuren",
      description: "Stel uw UI-voorkeuren in voor AiAppsy LLM.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Geef uw AiAppsy LLM-instantie een whitelabel met uw eigen branding.",
    },
    chat: {
      title: "Chat",
      description: "Stel uw chatvoorkeuren in voor AiAppsy LLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Weergavetaal",
        description:
          "Selecteer de gewenste taal waarin de gebruikersinterface van AiAppsy LLM moet worden weergegeven - wanneer vertalingen beschikbaar zijn.",
      },
      logo: {
        title: "Merklogo",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "U moet zich authenticeren bij de AiAppsy LLM Community Hub voordat u items kunt publiceren.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Bescherm je AiAppsy LLM-instantie met een wachtwoord. Als je dit vergeet, is er geen herstelmethode, dus zorg ervoor dat je dit wachtwoord opslaat.",
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Verbind uw AiAppsy LLM-instantie met Telegram, zodat u vanuit elk apparaat kunt communiceren met uw werkruimtes.",
    setup: {
      step1: {
