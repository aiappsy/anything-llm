...
const TRANSLATIONS = {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "بيتا",
        description:
          "تمكين استخدام أدوات غير محدودة وتقليل استخدام رموز القطع بنسبة تصل إلى 80٪ لكل استعلام - يقوم AiAppsy LLM تلقائيًا باختيار المهارات المناسبة لكل طلب.",
        "max-tools": {
          title: "أدوات ماكس",
          description:
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "سيتم تحميل هذه الملفات إلى معالج المستندات الذي يعمل على هذه نسخة من AiAppsy LLM. هذه الملفات لا يتم إرسالها أو مشاركتها مع طرف ثالث.",
    },
    pinning: {
      what_pinning: 'ما هو عمل "تثبيت المستندات"؟',
      pin_explained_block1:
        "عندما تقوم بإرفاق مستند في AiAppsy LLM، سنقوم بإدخال محتوى المستند بالكامل في نافذة المطالبة الخاصة بـ LLM الخاص بك، وذلك حتى يتمكن LLM من فهم المحتوى بالكامل.",
      pin_explained_block2:
        "يعمل هذا بشكل أفضل مع **نماذج ذات سياق كبير** أو ملفات صغيرة ولكنها ضرورية لأساس المعرفة الخاص بها.",
      pin_explained_block3:
        'إذا لم تحصل على الإجابات التي ترغب بها بشكل افتراضي من AiAppsy LLM، فإن استخدام ميزة "التثبيت" هو طريقة رائعة للحصول على إجابات ذات جودة أعلى في نقرة واحدة.',
      accept: "حسناً، فهمت.",
    },
    watching: {
      what_watching: "ما الذي يفعله مشاهدة فيلم وثائقي؟",
      watch_explained_block1:
        "عندما **تشاهد** مستندًا في AiAppsy LLM، سيتم **مزامنة** محتوى المستند تلقائيًا من مصدره الأصلي على فترات منتظمة. وهذا سيؤدي إلى تحديث المحتوى تلقائيًا في كل مساحة عمل حيث يتم إدارة هذا الملف.",
  ...
  customization: {
    interface: {
      ...
      description: "حدد تفضيلات واجهة المستخدم الخاصة بـ AiAppsy LLM.",
    },
    branding: {
      title: "التسويق بالعلامة التجارية ووضع العلامات التجارية",
      description:
        "قم بتخصيص نسخة AiAppsy LLM الخاصة بك باستخدام العلامات التجارية الخاصة بك.",
    },
    chat: {
      title: "دردشة",
      description: "حدد تفضيلات الدردشة الخاصة بك لـ AiAppsy LLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "حدد اللغة المفضلة لعرض واجهة مستخدم AiAppsy LLM - عند توفر الترجمات.",
      },
      logo: {
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "يتطلب التحقق",
          description:
            "يجب عليك التحقق من هويتك مع مركز مجتمع AiAppsy LLM قبل نشر أي محتوى.",
