import AiAppsy LLMIcon from "@/media/logo/anything-llm-icon.png";
...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of AiAppsy LLM.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "AiAppsy LLM Embedder",
    description: [
      "Your document text is embedded privately on this instance of AiAppsy LLM.",
    ],
    logo: AiAppsy LLMIcon,
  },
  openai: {
    name: "OpenAI",
    policyUrl: "https://openai.com/policies/privacy-policy/",
