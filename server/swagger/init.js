...
const doc = {
  info: {
    version: "1.0.0",
    title: "AiAppsy LLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your AiAppsy LLM instance. UI supplied by Swagger.io.",
  },
