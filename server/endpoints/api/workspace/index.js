      ...
      content: {
        "application/json": {
          example: {
            ...
            deletes: ["custom-documents/AiAppsy LLM.txt-hash.json"]
          }
        }
      }
    }
           ...
           example: {
             ...
             attachments: [
               ...
               },
               {
                 ...
                 mime: "application/AiAppsy LLM-document",
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "AiAppsy LLM.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
           ...
           example: [
            ...
            },
            {
            ...
            },
             {
              ...
              sources: [{title: "AiAppsy LLM.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM. This will only return in the final chunk."}],
              close: true,
              error: "null | text string of the failure mode."
            }
          ]
