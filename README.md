...
<p align="center">
  <a href="https://AiAppsy LLM.com"><img src="https://github.com/Mintplex-Labs/aiappsy-llm/blob/master/images/wordmark.png?raw=true" alt="AiAppsy LLM logo"></a>
</p>

<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="Mintplex-Labs%2Faiappsy-llm | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
    <b>AiAppsy LLM:</b> The all-in-one AI app you were looking for.<br />
...
<p align="center">
  ...
  <a href="https://github.com/Mintplex-Labs/aiappsy-llm/blob/master/LICENSE" target="_blank">
      <img src="https://img.shields.io/static/v1?label=license&message=MIT&color=white" alt="License">
  </a> |
  <a href="https://docs.AiAppsy LLM.com" target="_blank">
    Docs
  </a> |
   <a href="https://my.mintplexlabs.com/aio-checkout?product=AiAppsy LLM" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">
👉 AiAppsy LLM for desktop (Mac, Windows, & Linux)! <a href="https://AiAppsy LLM.com/download" target="_blank"> Download Now</a>
</p>
...
![Chatting](https://github.com/Mintplex-Labs/aiappsy-llm/releases/download/v1.11.2/AiAppsy LLM720p.gif)
...
AiAppsy LLM is the all-in-one AI application that lets you build a private, fully-featured ChatGPT—without compromises. Connect your favorite local or cloud LLM, ingest your documents, and start chatting in minutes. Out of the box you get built-in agents, multi-user support, vector databases, and document pipelines — no extra configuration required.

AiAppsy LLM supports multiple users as well where you can control the access and experience per user without compromising the security or privacy of the instance or your intellectual property.

## Cool features of AiAppsy LLM

- [Intelligent Skill Selection](https://docs.AiAppsy LLM.com/agent/intelligent-tool-selection) Enable **unlimited** tools for your models while reducing token usage by up to 80% per query
- [**No-code AI Agent builder**](https://docs.AiAppsy LLM.com/agent-flows/overview)
- [**Full MCP-compatibility**](https://docs.AiAppsy LLM.com/mcp-compatibility/overview)
- **Multi-modal support (both closed and open-source LLMs!)**
- [**Custom AI Agents**](https://docs.AiAppsy LLM.com/agent/custom/introduction)
- 👤 Multi-user instance support and permissioning _Docker version only_
- 🦾 Agents inside your workspace (browse the web, etc)
- 💬 [Custom Embeddable Chat widget for your website](https://github.com/Mintplex-Labs/AiAppsy LLM-embed/blob/main/README.md) _Docker version only_
...
- [Novita AI (chat models)](https://novita.ai/model-api/product/llm-api?utm_source=github_aiappsy-llm&utm_medium=github_readme&utm_campaign=link)
- [PPIO](https://ppinfra.com?utm_source=github_aiappsy-llm)
...
- [AiAppsy LLM Native Embedder](/server/storage/models/README.md) (default)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [AiAppsy LLM Built-in](https://github.com/Mintplex-Labs/aiappsy-llm/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- `embed`: Submodule for generation & creation of the [web embed widget](https://github.com/Mintplex-Labs/AiAppsy LLM-embed).
- `browser-extension`: Submodule for the [chrome browser extension](https://github.com/Mintplex-Labs/AiAppsy LLM-extension).

## 🛳 Self-Hosting

Mintplex Labs & the community maintain a number of deployment methods, scripts, and templates that you can use to run AiAppsy LLM locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
[or set up a production AiAppsy LLM instance without Docker →](./BARE_METAL.md)
...
AiAppsy LLM by Mintplex Labs Inc contains a telemetry feature that collects anonymous usage information.

<details>
<summary><kbd>More about Telemetry & Privacy for AiAppsy LLM</kbd></summary>

### Why?

We use this information to help us understand how AiAppsy LLM is used, to help us prioritize work on new features and bug fixes, and to help us improve AiAppsy LLM's performance and stability.
...
[View all telemetry events in source code](https://github.com/search?q=repo%3AMintplex-Labs%2Faiappsy-llm%20.sendTelemetry(&type=code)

</details>

## 👋 Contributing

- [Contributing to AiAppsy LLM](./CONTRIBUTING.md) - How to contribute to AiAppsy LLM.
...
[![AiAppsy LLM contributors](https://contrib.rocks/image?repo=mintplex-labs/aiappsy-llm)](https://github.com/mintplex-labs/aiappsy-llm/graphs/contributors)

[![Star History Chart](https://api.star-history.com/svg?repos=mintplex-labs/aiappsy-llm&type=Timeline)](https://star-history.com/#mintplex-labs/aiappsy-llm&Date)
...
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/aiappsy-llm&branch=render
[render-btn]: https://render.com/images/deploy-to-render-button.svg
[render-deploy]: https://render.com/deploy?repo=https://github.com/Mintplex-Labs/aiappsy-llm&branch=render
...
[elestio-deploy]: https://elest.io/open-source/AiAppsy LLM
[northflank-btn]: https://assets.northflank.com/deploy_to_northflank_smm_36700fb050.svg
[northflank-deploy]: https://northflank.com/stacks/deploy-AiAppsy LLM
