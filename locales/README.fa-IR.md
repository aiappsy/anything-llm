...
<p align="center" dir="rtl">
    <b>AiAppsy LLM:</b> اپلیکیشن همه‌کاره هوش مصنوعی که دنبالش بودید.<br />
...
<p align="center" dir="rtl">
👈 AiAppsy LLM برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://AiAppsy LLM.com/download" target="_blank">دانلود کنید</a>
</p>
...
AiAppsy LLM اپلیکیشن همه‌کاره هوش مصنوعی است که به دنبال آن بودید. AiAppsy LLM شامل همه چیزهایی است که برای ساخت یک ChatGPT خصوصی بدون سازش با استفاده از ارائه‌دهندگان LLM محلی یا ابری مورد علاقه خود نیاز دارید. AiAppsy LLM بسیار قابل پیکربندی است، اما همه چیزهایی که برای شروع کار نیاز دارید از جمله عامل‌های داخلی، پشتیبانی چند کاربره، پایگاه‌های داده برداری، خطوط لوله دریافت اسناد و موارد دیگر را به صورت آماده ارائه می‌دهد.

AiAppsy LLM همچنین از چندین کاربر پشتیبانی می‌کند که می‌توانید دسترسی و تجربه هر کاربر را بدون به خطر انداختن امنیت یا حریم خصوصی نمونه یا مالکیت فکری خود کنترل کنید.

</div>
<div dir="rtl">

## ویژگی‌های جذاب AiAppsy LLM

- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.AiAppsy LLM.com/agent/custom/introduction)
...
- [AiAppsy LLM Native Embedder](/server/storage/models/README.md) (پیش‌فرض)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [AiAppsy LLM Built-in](https://github.com/Mintplex-Labs/aiappsy-llm/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/Mintplex-Labs/AiAppsy LLM-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/Mintplex-Labs/AiAppsy LLM-extension).
...
Mintplex Labs و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای AiAppsy LLM به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
...
[یا راه‌اندازی نمونه تولیدی AiAppsy LLM بدون Docker →](../BARE_METAL.md)
...
AiAppsy LLM توسط Mintplex Labs Inc دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.

<details>
<summary><kbd>اطلاعات بیشتر درباره تله‌متری و حریم خصوصی AiAppsy LLM</kbd></summary>

### چرا؟

<div dir="rtl">
ما از این اطلاعات برای درک نحوه استفاده از AiAppsy LLM، اولویت‌بندی کار روی ویژگی‌های جدید و رفع اشکالات، و بهبود عملکرد و پایداری AiAppsy LLM استفاده می‌کنیم.
</div>
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3AMintplex-Labs%2Faiappsy-llm%20.sendTelemetry(&type=code)
...
[![مشارکت‌کنندگان AiAppsy LLM](https://contrib.rocks/image?repo=mintplex-labs/aiappsy-llm)](https://github.com/mintplex-labs/aiappsy-llm/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=mintplex-labs/aiappsy-llm&type=Timeline)](https://star-history.com/#mintplex-labs/aiappsy-llm&Date)
