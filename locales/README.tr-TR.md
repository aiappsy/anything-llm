...
<p align="center">
<b>AiAppsy LLM:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
👉 Masaüstü için AiAppsy LLM (Mac, Windows ve Linux)! <a href="https://AiAppsy LLM.com/download" target="_blank"> Şimdi İndir</a>
</p>
...
AiAppsy LLM, aradığınız hepsi bir arada yapay zeka uygulamasıdır. AiAppsy LLM, favori yerel veya bulut LLM sağlayıcılarınızı kullanarak hiçbir ödün vermeden özel bir ChatGPT oluşturmak için ihtiyacınız olan her şeyi içerir. AiAppsy LLM son derece özelleştirilebilir olmakla birlikte, yerleşik ajanlar, çok kullanıcılı destek, vektör veritabanları, belge alma işlem hatları ve daha fazlası gibi hemen başlamak için ihtiyacınız olan her şeyle birlikte gelir.

AiAppsy LLM ayrıca birden fazla kullanıcıyı da destekler; burada örneğin güvenliğini veya gizliliğini ya da fikri mülkiyetinizi tehlikeye atmadan kullanıcı başına erişimi ve deneyimi kontrol edebilirsiniz.

## AiAppsy LLM’in Harika Özellikleri

- 🆕 [**Özel Yapay Zeka Ajanları**](https://docs.AiAppsy LLM.com/agent/custom/introduction)
- 🆕 [**Kod yazmadan AI Ajanı oluşturma aracı**](https://docs.AiAppsy LLM.com/agent-flows/overview)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Mintplex-Labs/AiAppsy LLM-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Mintplex-Labs/AiAppsy LLM-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Mintplex-Labs/AiAppsy LLM-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

Mintplex Labs ve topluluk, AiAppsy LLM'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında AiAppsy LLM kurun →](../BARE_METAL.md)
...
Mintplex Labs Inc. tarafından geliştirilen AiAppsy LLM, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>
<summary><kbd>AiAppsy LLM için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, AiAppsy LLM’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AMintplex-Labs%2Faiappsy-llm%20.sendTelemetry(&type=code)
